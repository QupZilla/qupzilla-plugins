...
MailHandle_Handler::MailHandle_Handler(const QString &settingsPath, QObject* parent)
    : QObject(parent)
...
QString MailHandle_Handler::settingsFile()
{
    return m_settingsFile;
}

void MailHandle_Handler::loadSettings()
{
